...
public class AuthController {
    ...
    public ResponseEntity<String> register(@RequestBody RegisterRequest request) {
        ...
        // Buscamos el rol en la base de datos o lo creamos si no existe
        Role userRole = roleRepository.findByName("USER")
                .orElseGet(() -> {
                    Role newRole = new Role();
                    newRole.setName("USER");
                    return roleRepository.save(newRole); // Guardamos el nuevo rol en la BD
                });
        ...
        //newUser.setRoles(Collections.singleton(userRole)); // Asignamos el rol encontrado o creado
