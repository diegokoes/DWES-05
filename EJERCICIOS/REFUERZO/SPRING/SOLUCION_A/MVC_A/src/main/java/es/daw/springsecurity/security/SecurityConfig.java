    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/events/nuevo").hasRole("ADMIN")
                ...
                .formLogin(login -> login
                        ...
                        .defaultSuccessUrl("/funcionalidades", true) // Si el login es exitoso, va a funcionalidades
                ...
                .logout(logout -> logout
                        ...
                        //.invalidateHttpSession(true) // Ahora se invalida la sesión al cerrar sesión //EXAMEN // no es necesario
                        //.deleteCookies("JSESSIONID") // Elimina la cookie de sesión //EXAMEN // no es necesario
                        .permitAll()
