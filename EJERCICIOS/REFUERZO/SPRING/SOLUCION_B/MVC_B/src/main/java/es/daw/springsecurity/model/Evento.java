...
public class Evento {
    ...
    @Pattern(regexp = "^EV\\d{3}$", message = "El código debe comenzar con 'EV' seguido de tres dígitos (Ejemplo: EV123)")
    ...
    @DecimalMax(value = "200.00", message = "El precio no puede ser mayor a 200 euros")
