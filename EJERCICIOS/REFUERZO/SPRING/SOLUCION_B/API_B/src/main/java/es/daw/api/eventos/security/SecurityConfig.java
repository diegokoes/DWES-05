package es.daw.api.eventos.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http //al trabajar con un api rest sin estado. No hay frontend. No aplicamos protección csrf (tema sesiones). No aplicamos sesiones, sino tokens
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    config.setAllowedOrigins(List.of("http://localhost:8081")); // Cambia por el origen correcto
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Permitir GET para los eventos y organizadores
                        .requestMatchers(HttpMethod.GET, "/eventos/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/organizadores/**").permitAll()

                        // Permitir acceso a la lista de eventos personalizada
