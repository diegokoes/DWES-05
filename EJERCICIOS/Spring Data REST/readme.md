...
```
GET http://localhost:8080/products/search/findByNameContainingIgnoreCase?name=Producto%201

GET http://localhost:8080/products/search/findByPriceGreaterThan?price=200

```

### Añadir nuevos endpoints con un nuevo controlador
...
```
http://localhost:8080/products/expensive?precio=100
```
